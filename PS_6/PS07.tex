...
\title{Chloe Sutter: Problem Set 7}
\date{Due: May 6, 2020}
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=39, lastline=53]{PS7_Sutter.R}  
	
	\newpage
	\item [(b)]
	Interpret the \texttt{marginality.06} and \texttt{PAN.governor.06} coefficients.
	
	A one unit increase in the number of times the winning PAN president visited a district would yield a -2.09 unit decrease in poverty levels \& a 0.2 unit decrease in wether or not a state has a PAN governor.

	
	\item [(c)]
	Provide the estimated mean number of visits from the winning PAN presidential candidate for a hypothetical district that was competitive (\texttt{competitive.district}=1), had an average poverty level (\texttt{marginality.06} = 0), and a PAN governor (\texttt{PAN.governor.06}=1).
	
	\lstinputlisting[language=R, firstline=59, lastline=61]{PS7_Sutter.R}  
...
\lstinputlisting[language=R, firstline=65, lastline=67]{PS7_Sutter.R}  
...
\begin{enumerate}
	...
	\lstinputlisting[language=R, firstline=68, lastline=75]{PS7_Sutter.R}  
	...
	\lstinputlisting[language=R, firstline=78, lastline=83]{PS7_Sutter.R}  
	...
	\lstinputlisting[language=R, firstline=86, lastline=91]{PS7_Sutter.R}  
	...
	\lstinputlisting[language=R, firstline=94, lastline=99]{PS7_Sutter.R}  
	...
	\lstinputlisting[language=R, firstline=103, lastline=105]{PS7_Sutter.R}  

	Yes, it is worthwhile because it tells us which variables in particular are significant; one is more significant than the rest.
